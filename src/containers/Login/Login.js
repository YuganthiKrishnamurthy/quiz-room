        ...
        <Aux >
          <section>
            ...
            <article className={classes.loginContent}>
              <div className={classes.quizroom}>Quiz room</div>
              <div className="row">
                <div className="col-lg-12">
                  <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                      <div className={classes.loginDetails}>Username</div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div className="row">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                      <div className={classes.loginDetails}>Password</div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                      <div className={classes.passwordField}>
                        <input type="password"  onChange={(event)=>this.login_functinalities.enterCredentials(event,"enteredPassword")}/>
